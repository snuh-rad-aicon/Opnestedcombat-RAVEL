...
if __name__ == '__main__':
    ...
    # target_root = '/data/aicon/data/AMC/molGBM/processed'
    ...
    # target_root = '/data/aicon/data/AMC/molGBM/processed/nifti'
    # os.system(f'ssh -p 7777 jhlee@147.46.97.169 "mkdir -p /media/data/aicon/data/AMC/molGBM/processed"')
    # os.system(f'scp -P 7777 -r /data/aicon/data/AMC/molGBM/processed/info jhlee@147.46.97.169:/media/data/aicon/data/AMC/molGBM/processed')
    
    
    # using rsync
    source_root = '/data/aicon/data/AMC/molGBM/processed/nifti'
    target_root = '/media/data/aicon/data/AMC/molGBM/processed/nifti'
