...
for d in ['t1_bet.nii.gz']: 
    file_list.extend(glob(f'/mnt/hdd1/shan/GBM/SNUH/nifti/**/{d}', recursive=True))
...
partial_function = partial(normalize, target_root='/mnt/hdd1/shan/GBM/SNUH/processed', subdir=True)
