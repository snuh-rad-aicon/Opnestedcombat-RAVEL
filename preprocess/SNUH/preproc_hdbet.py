...
if __name__ == '__main__':
    ...
    patient_dir_list = [p for p in patient_dir_list if not os.path.exists(f'{target_root}/{p.split("/")[-2]}/{p.split("/")[-1]}/t1_bet.nii.gz') 
                        and not os.path.exists(f'{target_root}/{p.split("/")[-2]}/{p.split("/")[-1]}/t1ce_bet.nii.gz')
                        and not os.path.exists(f'{target_root}/{p.split("/")[-2]}/{p.split("/")[-1]}/t2_bet.nii.gz')
                        and not os.path.exists(f'{target_root}/{p.split("/")[-2]}/{p.split("/")[-1]}/flair_bet.nii.gz')]
